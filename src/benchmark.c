...
/*   Updated: 2026/03/06 13:04:56 by maroard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_benchmark(t_ctx ctx)
{
	...
	ft_printf_fd(2, "[BENCHMARK] Strategy: %s / %s\n",
		strat_names[ctx.strategy], complexity[ctx.bench.complexity]);
	ft_printf_fd(2, "[BENCHMARK] Total operations: %d\n", ctx.bench.total_ops);
	ft_printf_fd(2,
		"[BENCHMARK] sa: %d sb: %d ss: %d pa: %d pb: %d\n",
		ctx.bench.ops[0], ctx.bench.ops[1], ctx.bench.ops[2],
		ctx.bench.ops[3], ctx.bench.ops[4]);
	ft_printf_fd(2,
		"[BENCHMARK] ra: %d rb: %d rr: %d rra: %d rrb: %d rrr: %d\n",
